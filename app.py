...
class UserInput(BaseModel):
    ...
    income_lpa: Annotated[float, Field(gt=0, description="Annual income in lakhs per annum")]
    smoker: bool = Field(..., description="Whether the user is a smoker or not")        
...
@app.get('/')
def read_root():
    return {"message": "Welcome to the Insurance Premium Category Prediction API. Use the /predict endpoint to get predictions."}